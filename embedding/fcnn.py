...
# 
#	FCNN: Frames supported Convolution Neural Network
...
VM_HEIGHT = 30
VM_WIDTH = 2048
CPKT_FILE_NAME = 'video_embedding_fcnn.cpkt'
STD_FCNN_ARCH_V1 = {"in_height": 30, "frame_conv_layers": [{"o_channels": 32, "conv_h": 4, "pool_h": 2}, {"o_channels": 16, "conv_h": 4, "pool_h": 2}, {"o_channels": 8, "conv_h": 3, "pool_h": 2}, {"o_channels": 4, "conv_h": 3, "pool_h": 2}, {"o_channels": 2, "conv_h": 2, "pool_h": 2}, {"o_channels": 1, "conv_h": 2, "pool_h": 2}], "dense_conn_layers": [{"o_size": 1024}], "in_width": 2048, "out_size": 28}
...
class FCNN:
	...
	"""
	def __init__(self, arch_dict = STD_FCNN_ARCH_V1): 
