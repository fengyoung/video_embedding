...
def prepare_read_from_tfrecord(tfrecord_files, label_num, v_height, v_width, batch_size = 1, max_epochs = None, num_threads = 4, shuffle = False): 
	...
	Args:
		...
		label_num: An `integer`. Number of label size 
	...
	File format:
		...
		features: {
		  ...
		  feature: {
		    ...
		    value: {
		      float_list: {
		        value: [label_num float values of 0. or 1.] 
		      }
		    }
		  }
		  feature: {
